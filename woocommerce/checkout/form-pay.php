	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'slovo' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'slovo' ); ?></th>
			</tr>
		</thead>
		<tbody>
