...
That’s what slovo is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for slovo.

At the moment, slovo is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# slovo WordPress Theme Framework

Website: [https://understrap.com](https://understrap.com)

Child Theme Project: [https://github.com/holger1411/slovo-child](https://github.com/holger1411/slovo-child)
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or slovo variables here
...
- Download the slovo folder from GitHub or from slovo.com
